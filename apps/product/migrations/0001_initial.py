...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(primary_key=True, serialize=False, unique=True, verbose_name='Уникальный идентификатор')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.CharField(max_length=155, verbose_name='Артикул')),
                ('product_size', models.CharField(default='S-XXL', max_length=155, verbose_name='Размер товара')),
                ('material', models.CharField(default='S-XXL', max_length=155, verbose_name='Материал')),
                ...
                ('price_type', models.CharField(choices=[('RUB', 'RUB'), ('USD', 'USD')], default='RUB', max_length=10, verbose_name='Цена валюта')),
