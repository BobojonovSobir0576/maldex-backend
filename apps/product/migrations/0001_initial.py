    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_size', models.CharField(blank=True, default='S-XXL', max_length=155, null=True, verbose_name='Размер товара')),
                ('material', models.CharField(blank=True, default='S-XXL', max_length=155, null=True, verbose_name='Материал')),
                ...
                ('weight', models.CharField(blank=True, max_length=155, null=True, verbose_name='Масса')),
                ('barcode', models.CharField(blank=True, max_length=155, null=True, verbose_name='Штрих-код продукта')),
                ('ondemand', models.BooleanField(blank=True, default=True, null=True)),
                ('moq', models.CharField(blank=True, default='0', max_length=256, null=True)),
